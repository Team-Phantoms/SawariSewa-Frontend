...
data class clientWorkHistory  (
    ...
    companion object CREATOR : Parcelable.Creator<clientWorkHistory> {
        override fun createFromParcel(parcel: Parcel): clientWorkHistory {
            return clientWorkHistory(parcel)
        }

        override fun newArray(size: Int): Array<clientWorkHistory?> {
